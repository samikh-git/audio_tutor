...
2. Add screen type to `App.tsx` ScreenType union
3. Add navigation handler in `App.tsx`
4. Add screen render logic in `App.tsx`

### Styling Guidelines

- Use consistent color scheme (`#667eea` primary)
...
- **iOS Simulator**: Test on different iPhone models
...
- **Dependency conflicts**: Update to latest compatible versions

### Runtime Issues
- **Navigation problems**: Check screen type definitions
- **Animation glitches**: Ensure proper cleanup in useEffect
- **Performance issues**: Optimize re-renders and animations
...
- Profile animations and transitions
...
**Audio Tutor Mobile Client** - Making language learning mobile and accessible!
